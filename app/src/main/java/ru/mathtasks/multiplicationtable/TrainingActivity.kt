...
class TrainingActivity : AppCompatActivity() {
    ...
    private fun createNextMultipliers() {
        ...
        for (nextMultiplier in taskProvider.nextMultipliers) {
            val tv = TextView(this).apply {
                ...
                setTextColor(ContextCompat.getColor(context, R.color.trainingActivityNextMultiplier))
                maxLines = 1
    ...
    private fun animateTask(nextMultiplier: Boolean) {
        taskAnimator?.end()
        findViewById<TextView>(R.id.tv_multiplier).post {   // give time to relocate after taskAnimator.end
    ...
    private fun animateNextMultiplier(): Animator {
        ...
        val startRightTv = rlOuter.width - (nextMultiplierLoc[0] - rlOuterLoc[0]) - nextMultiplier.width
        val tv = TextView(this).apply {
            ...
            layoutParams = RelativeLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT).apply {
                ...
                setMargins(0, startYTv, startRightTv, 0)
            }
        }
        rlOuter.addView(tv)
        ...
        val endRightTv = rlOuter.width - (multiplierLoc[0] - rlOuterLoc[0]) - multiplier.width
        ...
        val transformAnimator = ValueAnimator.ofFloat(0f, 1f).apply {
            ...
            addUpdateListener { animator ->
                ...
                tv.layoutParams = RelativeLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT).apply {
                    addRule(RelativeLayout.ALIGN_PARENT_RIGHT)
                    setMargins(0, (startYTv + (endYTv - startYTv) * progress).toInt(), (startRightTv + (endRightTv - startRightTv) * progress).toInt(), 0)
                }
                if (nextNextMultiplier != null) {
        ...
        return AnimatorSet().apply {
            ...
            addListener(object : AnimatorListenerAdapter() {
                override fun onAnimationEnd(animation: Animator?) {
                    ...
                    if (nextMultipliers.size > 1)  // don't remove last as it will shut ll_nextMultipliers
    ...
    private fun onOkKey() {
        ...
        animateAnswer(correct) {
            ...
            if (correct) {
                fieldRows[taskProvider.multiplier - 1].animateProductShowType(ProductShowType.None)
