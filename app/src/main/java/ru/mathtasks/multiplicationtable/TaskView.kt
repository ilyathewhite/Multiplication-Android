...
class TaskView(context: Context, attrs: AttributeSet) : LinearLayout(context, attrs) {
    ...
    private fun layoutNextMultiplier(constraintSet: ConstraintSet, id: Int, prevId: Int?) {
        ...
        constraintSet.setMargin(id, ConstraintSet.BOTTOM, resources.getDimensionPixelSize(R.dimen.taskViewNextMultiplierBottomMargin))
        ...
        if (prevId == null) {
            ...
            constraintSet.setMargin(id, ConstraintSet.LEFT, resources.getDimensionPixelSize(R.dimen.taskViewFirstNextMultiplierShift))
